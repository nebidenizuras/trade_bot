...
from telegram_bot import warn, send_message_to_telegram, channel_01
...
send_message_to_telegram(channel_01, warn + warn + "Albız_v3 Started" + warn + warn)
...
while(True):
    ...
    ### LONG İŞLEM ###
        ...
        if (start == True) and (position == "") and (long_signal and long_trend):
            ...
            debugMsg += "\n"  
            send_message_to_telegram(channel_01, debugMsg)
            debugMsg = ""  
